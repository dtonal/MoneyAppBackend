...
public class FacesAuthFilter implements Filter {
	public FacesAuthFilter() {
	}
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		try {
			...
			// allow user to proceed if url is login.jsf or user logged in or user is
			// accessing any page in //public folder
			String reqURI = req.getRequestURI();
			if (reqURI.indexOf("/login.jsf") >= 0 || (ses != null && ses.getAttribute("userId") != null)
